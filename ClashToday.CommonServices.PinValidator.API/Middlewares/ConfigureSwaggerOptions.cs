...
namespace ClashToday.CommonServices.PinValidator.API.Middlewares;
...
public class ConfigureSwaggerOptions : IConfigureNamedOptions<SwaggerGenOptions>
{
    ...
    private OpenApiInfo CreateVersionInfo(ApiVersionDescription desc)
    {
        ...
        {
            Title = $"{GetNameService(System.Reflection.Assembly.GetExecutingAssembly().GetName().Name)} - Developed by ClashToday",
